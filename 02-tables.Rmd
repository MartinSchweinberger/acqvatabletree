...
mytable <- base::readRDS(here::here("data", "myrda.rda"))
# inspect
head(mytable) 
```
...
# load data with read.delim
tab1 <- read.delim(here::here("data", "mlrdata.txt"), sep = "\t", header = TRUE)
...
# load data
excelcomp <- readxl::read_excel(here::here("data", "data_german.xlsx"), sheet = 1)
# inspect
head(excelcomp)
```
...
# load data
csvdat <- read.csv(here::here("data", "mycsv.csv"))
# inspect
head(csvdat)
```
...
# load new data
newdata <- read.delim(here::here("data", "mlrdata.txt"), sep = "\t", header = TRUE)
# inspect
head(newdata)
```
...
pipeddata <- read.delim(here::here("data", "mlrdata.txt"), sep = "\t", header = TRUE) %>%
